...
function systemPrompt(slug, lang) {
  ...
  return `Sei il concierge digitale di InternoUno, un affittacamere a Roma. Rispondi SEMPRE e SOLO nella lingua in cui è scritto il messaggio dell'ospite, per tutta la risposta, senza mescolare lingue (se il messaggio è troppo breve per capirlo usa "${lang}").
